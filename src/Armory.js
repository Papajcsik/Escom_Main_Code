...
import { Colors, IMAGES, ArmorImages, Musics } from './Constants'
...
export default function Armory(props) {
  ...
  const height = Dimensions.get('window').height;
    ...
    const [megoldas, setMegoldas] = useState( ["a","b","c","d","e"] );                       //megoldas

  const [jelenlegi, setJelenlegi] = useState([ null, null, null, null, null ]);                     //beirt kod
  const [szinesJelenlegi, setSzinesJelenlegi] = useState([]);        //kopizott beiras szinesen
  const [superiorJelenlegi, setSuperiorJelenlegi] = useState([ null, null, null, null, null ]);     //green lock a beirasnal
  ...
  useEffect(() => {
    ...
    console.log("buzi", userSnap.data().Escoins)
    };
  getUsers();
  }, []);

  const [dumpingTomb, setDumpingTomb] = useState([ null, null, null, null, null ]);
...
///////////////////////////////////////////////////////////////timer
  ...
  const ido = 50000;                                 //kezdo ido milisec-ben // ez 120 000 === 2 perc
  ...
  const handleClear = () => {
    if(true)
    {
      ...
      jelenlegi.push(null);
       ...
       for(var m=0; jelenlegi[m] !== null || m === 4; m++ )
          {
            if(m >= 4)
            {
              lastElementIndex = 4;
...
const Game_plus = async () => {

  setId(auth.currentUser.uid)
const userref = collection(db, "users", id )
const res = await userref.update({Played: FieldValue.increment(1)})
...
const backgroundImage = require('../gombok/escom-mobil-gombokuj-nagy-hatter-armor.png');
 return (
    ...
    <ImageBackground source={backgroundImage} style={GlobalStyles.backGroundImage} resizeMode="cover">
      <View style={{borderWidth: 0, borderColor: Colors.white, height: "8%", flexDirection: 'row',  alignItems:'center', justifyContent: 'space-between' }}>
         ...
         <View style={{position: 'relative',  height: "100%", aspectRatio: 1.4, justifyContent: 'center', paddingLeft: "5%" ,borderWidth: 0, borderColor: Colors.white}}>
          <TouchableOpacity onPress={() => {setGiveUpModalState(true)}} style={{borderColor: Colors.blue, borderWidth: 1, height: "50%", width:"50%", alignItems: 'center', justifyContent: 'center'}}>
        ...
        <View style={{borderWidth: 0, borderColor: Colors.white, height: "100%", aspectRatio: 3,}}>
            <Text style={[GlobalStyles.szoveg, { paddingTop:"2%", }]} >ARMOR</Text>
        ...
        <View style={[GlobalStyles.szinezettGomsorKeret,{bottom:"2%"},]} >
              {szinesJelenlegi.map((element, i) => (
                <View
                  ...
                  {backgroundColor: getBackGroundColor(element, i),}
                  ]}>
                  {
                    element === 'a' ? 
                        <Image source={ArmorImages.gomb1} key={"A"} style={GlobalStyles.felsoGombKepek}></Image> :
                    element === 'b' ?
                        <Image source={ArmorImages.gomb2} key={"B"} style={GlobalStyles.felsoGombKepek}></Image> :
                    element === 'c' ? 
                        <Image source={ArmorImages.gomb3} key={"C"} style={GlobalStyles.felsoGombKepek}></Image> :
                    element === 'd' ?
                        <Image source={ArmorImages.gomb4} key={"D"} style={GlobalStyles.felsoGombKepek}></Image> :
                    
                    element === 'e' ? 
                        <Image source={ArmorImages.gomb5} key={"E"} style={GlobalStyles.felsoGombKepek}></Image> :
                    element === 'f' ?
                        <Image source={ArmorImages.gomb6} key={"F"} style={GlobalStyles.felsoGombKepek}></Image> :
                    element === 'g' ? 
                        <Image source={ArmorImages.gomb7} key={"G"} style={GlobalStyles.felsoGombKepek}></Image> :
                    element === 'h' ?
                        <Image source={ArmorImages.gomb8} key={"H"} style={GlobalStyles.felsoGombKepek}></Image> :
                    
                    element === 'i' ? 
                        <Image source={ArmorImages.gomb9} key={"I"} style={GlobalStyles.felsoGombKepek}></Image> :
                    element === 'j' ?
                        <Image source={ArmorImages.gomb10} key={"J"} style={GlobalStyles.felsoGombKepek}></Image> :
                    element === 'k' ? 
                        <Image source={ArmorImages.gomb11} key={"K"} style={GlobalStyles.felsoGombKepek}></Image> :
                    element === 'l' ?
                        <Image source={ArmorImages.gomb12} key={"L"} style={GlobalStyles.felsoGombKepek}></Image> :
                    
                    element === 'm' ? 
                        <Image source={ArmorImages.gomb13} key={"M"} style={GlobalStyles.felsoGombKepek}></Image> :
                    element === 'n' ?
                        <Image source={ArmorImages.gomb14} key={"N"} style={GlobalStyles.felsoGombKepek}></Image> :
                    element === 'o' ? 
                        <Image source={ArmorImages.gomb15} key={"O"} style={GlobalStyles.felsoGombKepek}></Image> :
                    element === 's' ?
                        <Image source={ArmorImages.gomb16} key={"S"} style={GlobalStyles.felsoGombKepek}></Image> :
          ...
          <View style={GlobalStyles.felsoGombSorKeret} >
            {jelenlegi.map((element, i) => (
              <View
                style={[GlobalStyles.felsoIrkaloButtonKeret, 
                {backgroundColor: Colors.opacityBlue, }, GlobalStyles.shadowProp
                ]}>
                {
                   element === 'a' ? 
                        <Image source={ArmorImages.gomb1} key={"A"} style={GlobalStyles.felsoGombKepek}></Image> :
      ...
      <View style={{borderColor: Colors.white, borderWidth: 0,  height: "47.4%", aspectRatio: 1, justifyContent: 'flex-end', justifyContent: 'flex-end', alignSelf: 'center' }}>
        ...
        <View style={GlobalStyles.billentyuzetKeret} >
          ...
          <View style={GlobalStyles.gombKeret}>
            <Pressable onPress={() => {KeyboardHandler("a", 0)}} style={GlobalStyles.gombok} title="A">
              ...
              <Image source={ArmorImages.gomb1} style={GlobalStyles.gombKepek}></Image>
          ...
          <View style={GlobalStyles.gombKeret}>
            <Pressable onPress={() => {KeyboardHandler("b", 1)}} style={GlobalStyles.gombok} title="B">
              ...
              <Image source={ArmorImages.gomb2} style={GlobalStyles.gombKepek}></Image>
          ...
          <View style={GlobalStyles.gombKeret}>
            <Pressable onPress={() => {KeyboardHandler("c", 2)}} style={GlobalStyles.gombok} title="C">
              ...
              <Image source={ArmorImages.gomb3} style={GlobalStyles.gombKepek}></Image>
          ...
          <View style={GlobalStyles.gombKeret}>
            <Pressable onPress={() => {KeyboardHandler("d", 3)}} style={GlobalStyles.gombok} title="D">
              ...
              <Image source={ArmorImages.gomb4} style={GlobalStyles.gombKepek}></Image>
        ...
        <View style={GlobalStyles.billentyuzetKeret} >
          ...
          <View style={GlobalStyles.gombKeret}>
            <Pressable onPress={() => {KeyboardHandler("e", 4)}} style={GlobalStyles.gombok} title="E">
              ...
              <Image source={ArmorImages.gomb5} style={GlobalStyles.gombKepek}></Image>
          ...
          <View style={GlobalStyles.gombKeret}>
            <Pressable onPress={() => {KeyboardHandler("f", 5)}} style={GlobalStyles.gombok} title="F">
              ...
              <Image source={ArmorImages.gomb6} style={GlobalStyles.gombKepek}></Image>
          ...
          <View style={GlobalStyles.gombKeret}>
            <Pressable onPress={() => {KeyboardHandler("g", 6)}} style={GlobalStyles.gombok}title="G">
              ...
              <Image source={ArmorImages.gomb7} style={GlobalStyles.gombKepek}></Image>
          ...
          <View style={GlobalStyles.gombKeret}>
            <Pressable onPress={() => {KeyboardHandler("h", 7)}} style={GlobalStyles.gombok} title="H">
              ...
              <Image source={ArmorImages.gomb8} style={GlobalStyles.gombKepek}></Image>
      ...
      <View style={GlobalStyles.billentyuzetKeret} >
        ...
        <View style={GlobalStyles.gombKeret}>
          <Pressable onPress={() => {KeyboardHandler("i", 8)}} style={GlobalStyles.gombok} title="I">
            ...
            <Image source={ArmorImages.gomb9} style={GlobalStyles.gombKepek}></Image>
        ...
        <View style={GlobalStyles.gombKeret}>
          <Pressable onPress={() => {KeyboardHandler("j", 9)}} style={GlobalStyles.gombok} title="J">
            ...
            <Image source={ArmorImages.gomb10} style={GlobalStyles.gombKepek}></Image>
        ...
        <View style={GlobalStyles.gombKeret}>
          <Pressable onPress={() => {KeyboardHandler("k", 10)}} style={GlobalStyles.gombok}title="K">
            ...
            <Image source={ArmorImages.gomb11} style={GlobalStyles.gombKepek}></Image>
        ...
        <View style={GlobalStyles.gombKeret}>
          <Pressable onPress={() => {KeyboardHandler("l", 11)}} style={GlobalStyles.gombok} title="L">
            ...
            <Image source={ArmorImages.gomb12} style={GlobalStyles.gombKepek}></Image>
      ...
      <View style={GlobalStyles.billentyuzetKeret} >
        ...
        <View style={GlobalStyles.gombKeret}>
          <Pressable onPress={() => {KeyboardHandler("m", 12)}} style={GlobalStyles.gombok} title="M">
            ...
            <Image source={ArmorImages.gomb13} style={GlobalStyles.gombKepek}></Image>
        ...
        <View style={GlobalStyles.gombKeret}>
          <Pressable onPress={() => {KeyboardHandler("n", 13)}} style={GlobalStyles.gombok} title="N">
            ...
            <Image source={ArmorImages.gomb14} style={GlobalStyles.gombKepek}></Image>
        ...
        <View style={GlobalStyles.gombKeret}>
          <Pressable onPress={() => {KeyboardHandler("o", 14)}} style={GlobalStyles.gombok}title="O">
            ...
            <Image source={ArmorImages.gomb15} style={GlobalStyles.gombKepek}></Image>
        ...
        <View style={GlobalStyles.gombKeret}>
          <Pressable onPress={() => {KeyboardHandler("s", 15)}} style={GlobalStyles.gombok} title="S">
            ...
            <Image source={ArmorImages.gomb16} style={GlobalStyles.gombKepek}></Image>
